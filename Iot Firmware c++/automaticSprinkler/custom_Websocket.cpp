...
void custom_Websocket::add_sent_data(const char* name, const long unsigned int data)
{
	this->buffer[name] = data;
}
...
void custom_Websocket::add_nested_sent_data(const char* name, const double data)
{
	this->objects[name] = data;
}

void custom_Websocket::add_nested_sent_data(const char* name, const unsigned long int data)
{
	this->objects[name] = data;
