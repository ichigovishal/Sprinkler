...
public:
	...
	void add_sent_data(const char* name, const long unsigned int data);
	...
	void add_nested_sent_data(const char* name, const double data);
	void add_nested_sent_data(const char* name, const unsigned long int data);
